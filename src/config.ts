...
export const CONFIG = {
  ...
  TIER_COOLDOWNS: {
    GOLD: Number(process.env.COOLDOWN_GOLD) || 8,
    SILVER: Number(process.env.COOLDOWN_SILVER) || 16,
    BRONZE: Number(process.env.COOLDOWN_BRONZE) || 20,
    DEFAULT: Number(process.env.COOLDOWN_DEFAULT) || 8760 * 10
  },
  DUTY_RESET_HOURS: Number(process.env.DUTY_RESET_HOURS) || 8
};
