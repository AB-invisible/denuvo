...
def main(app_id, game_name, steampass_uuid, generation_mode="gbe"):
    ...
    # ── Step 4: Build multi-mode output ──
    # The bot now ships both GBE and V1 payloads in every zip; the
    # installer auto-probes one, rolls back on failure, and falls forward
    # to the other. generation_mode is treated as a HINT (which mode to
    # try first), not a hard choice.
